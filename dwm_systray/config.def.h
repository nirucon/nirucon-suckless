...
static const char col_brightborder[] = "#FFFFFF"; /* Same as col_gray4 */
static const char *colors[][3]      = {
	/*               fg         bg         border   */
    [SchemeNorm] = { col_gray3, col_gray1, col_gray2 }, // Normal window color scheme
    [SchemeSel]  = { col_gray4, col_cyan,  col_brightborder }, // Selected window color scheme
};
...
static const char *volumeUp[] = { "wpctl", "set-volume", "@DEFAULT_AUDIO_SINC@", "5%+", NULL };
static const char *volumeDown[] = { "wpctl", "set-volume", "@DEFAULT_AUDIO_SINC@", "5%-", NULL };
static const char *volumeMute[] = { "wpctl", "set-mute", "@DEFAULT_AUDIO_SINC@", "toggle", NULL };
